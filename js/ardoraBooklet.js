...
$(document).ready(function(){
   $.fn.booklet.defaults = {
      name:"Librodigitalardora",
      width:1000,height:600,speed:1000,direction:"LTR",
...
function bookgotopage(page){var bookletIndex=page+1;if (page>= 1 && page<=11) {$("#mybook").booklet("gotopage", bookletIndex);}}
